...
import 'package:item_app/widgets/app_vortexVanquisher.dart';
import 'package:item_app/widgets/big_text.dart';
import 'package:item_app/widgets/expandable_text_widget.dart';

class VortexVanquisher extends StatelessWidget {
  const VortexVanquisher({Key? key}) : super(key: key);
          ...
          Positioned(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    vortexVanquisher(text: "Vortex Vanquisher",),
